...
#define CONFIG_JZ2440			1	/* on a 100ask jz2440v2 Board  */
...
#define CONFIG_BOOTARGS			"console=ttySAC0 init=/linuxrc root=/dev/nfs rw nfsroot=192.168.2.11:/opt/rootfs2 ip=192.168.2.12"
